...
@mark.parametrize("input_city", [('San Francisco'), ('New York'), ('London'), ('Sydney')])
...
@mark.parametrize("input_lat, input_lon", [(37.7749, -122.4194), (-37.7749, 122.4194), (35, 139), (-55.5, -37.5)])
...
@mark.parametrize("input_zip, expected_city", [(10007, 'New York'), (94105, 'San Francisco')])
